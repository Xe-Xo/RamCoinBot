...
exports.STARTING_BALANCE = (config ? config.STARTING_BALANCE : process.env.STARTING_BALANCE) || 1000;
exports.BALANCE_INCREASE = (config ? config.BALANCE_INCREASE : process.env.BALANCE_INCREASE) || 5;